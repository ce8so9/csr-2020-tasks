...
class JWE(object):
    ...
    def __init__(self, plaintext=None, protected=None, unprotected=None,
                 ...
                 header_registry=None, point_x=None, point_y=None, aes_key=None):
        """Creates a JWE token.
        ...
        if recipient:
            self.add_recipient(recipient, header=header, point_x=point_x, point_y=point_y, aes_key=aes_key)
        elif header:
    ...
    def _encrypt_fake(self, alg, enc, jh):
    ...
    def add_recipient(self, key, header=None, point_x=None, point_y=None, aes_key=None):
        ...
        if aes_key:
            wrapped = alg.wrap_fake(key, enc.wrap_key_size, self.cek, jh, point_x, point_y, aes_key)
        else:
